...
class FreshVegScreen extends StatefulWidget {
  const FreshVegScreen({super.key});

  @override
  State<FreshVegScreen> createState() => _FreshVegScreenState();
}

class _FreshVegScreenState extends State<FreshVegScreen> {
