...
class FreshFruitsScreen extends StatefulWidget {
  const FreshFruitsScreen({super.key});

  @override
  State<FreshFruitsScreen> createState() => _FreshFruitsScreenState();
}

class _FreshFruitsScreenState extends State<FreshFruitsScreen> {
