...
class SummerFruitsScreen2 extends StatefulWidget {
  const SummerFruitsScreen2({super.key});

  @override
  State<SummerFruitsScreen2> createState() => _SummerFruitsScreen2State();
}

class _SummerFruitsScreen2State extends State<SummerFruitsScreen2> {
