...
class SummerFruitsScreen extends StatefulWidget {
  const SummerFruitsScreen({super.key});

  @override
  State<SummerFruitsScreen> createState() => _SummerFruitsScreenState();
}

class _SummerFruitsScreenState extends State<SummerFruitsScreen> {
