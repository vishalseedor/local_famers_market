...
class FreshVegScreen2 extends StatefulWidget {
  const FreshVegScreen2({super.key});

  @override
  State<FreshVegScreen2> createState() => _FreshVegScreen2State();
}

class _FreshVegScreen2State extends State<FreshVegScreen2> {
